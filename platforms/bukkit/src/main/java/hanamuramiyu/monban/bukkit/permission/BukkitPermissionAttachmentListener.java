package hanamuramiyu.monban.bukkit.permission;
...
public final class BukkitPermissionAttachmentListener implements Listener {
    private final PlayerIdentityResolver identityResolver;
    private final boolean platformAuthenticated;
    private final BukkitPermissionAttachmentManager attachmentManager;

    public BukkitPermissionAttachmentListener(
            PlayerIdentityResolver identityResolver,
            boolean platformAuthenticated,
            BukkitPermissionAttachmentManager attachmentManager
    ) {

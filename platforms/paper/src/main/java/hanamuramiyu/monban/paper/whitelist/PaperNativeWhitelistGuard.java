...
public final class PaperNativeWhitelistGuard implements Listener {
    ...
    public PaperNativeWhitelistGuard() {
        this(false);
    }

    public PaperNativeWhitelistGuard(boolean backendPermissionsEnabled) {
    ...
    static void sendBlockedMessage(CommandSender sender, boolean backendPermissionsEnabled) {
        if (!sender.hasPermission(PaperWhitelistCommand.PERMISSION)) {
